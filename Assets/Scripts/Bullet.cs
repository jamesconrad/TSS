...
public class Bullet : MonoBehaviour
{
    ...
    private Vector3 OppositeImpactPoint(Collision2D collision)
    {
        ...
        RaycastHit2D hitInfo = Physics2D.Raycast(collision.GetContact(0).point + approxMaxDiameter * direction, -direction, approxMaxDiameter);
        ...
        DrawArrow(collision.GetContact(0).point + approxMaxDiameter * direction, -direction * approxMaxDiameter/*hitInfo.distance*/, 10, Color.cyan);
