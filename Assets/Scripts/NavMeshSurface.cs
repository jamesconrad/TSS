...
namespace UnityEngine.AI
{
    ...
    public class NavMeshSurface : MonoBehaviour
    {
        ...
        public void BuildNavMesh(IEnumerable<NavMeshBuildSource> additionalSources = null, NavMeshBuildSettings? overrideSettings = null)
        {
            ...
            var navMeshBuildSettings = overrideSettings.HasValue ? overrideSettings.Value : GetBuildSettings();
            var data = NavMeshBuilder.BuildNavMeshData(navMeshBuildSettings,
